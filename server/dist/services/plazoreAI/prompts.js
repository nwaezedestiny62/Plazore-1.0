export const PROMPT_VERSION = Number(process.env.PLAZORE_AI_PROMPT_VERSION) || 3;
...
Delivery fee: ${input.shipping.deliveryFee ?? "Not specified"}`
    ...
    const locationText = input.fulfillmentLocation
        ? `Ships from: ${input.fulfillmentLocation.displayLabel ||
            [
