...
personalizedBannerStateSchema.index({ user: 1, position: 1 }, { unique: true, partialFilterExpression: { user: { $type: "objectId" } } });
personalizedBannerStateSchema.index({ sessionId: 1, position: 1 }, {
    unique: true,
...
const PersonalizedBannerState = mongoose.model("PersonalizedBannerState", personalizedBannerStateSchema);
