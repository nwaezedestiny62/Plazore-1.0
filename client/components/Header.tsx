...
export default function Header({title, showMenu, showLogo, showSearch, showCart, showBack} : HeaderProps) {
        ...
        <View className='flex-row items-center gap-4'>
           ...
           {showCart && (
            <TouchableOpacity onPress={()=> router.push('/(tabs)/cart')} className='mr-3'>
                ...
                <View className='absolute -top-1 -right-1 bg-accent w-4 h-4 rounded-xl items-center justify-center'>
