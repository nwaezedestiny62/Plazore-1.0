...
/** External section imagery (Unsplash) */
const IMG = {
  commerce:
...
function SectionMedia({
  ...
  const h = Math.min(200, width * 0.48)
  return (
    <View style={[styles.mediaWrap, { width: width - 40 }]}>
      <Image
        source={{ uri }}
      ...
      />
      <LinearGradient
        colors={['transparent', 'rgba(9,11,15,0.75)']}
...
export default function AboutPlazore() {
  ...
  const onScroll = useCallback(
    (e: NativeSyntheticEvent<NativeScrollEvent>) => {
      ...
      const trigger = y + winH * 0.78
      Object.entries(sectionY.current).forEach(([id, top]) => {
        if (trigger >= top) mark(id)
      })
    },
    [winH, mark],
  )
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.topBar}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.topEyebrow}>PLAZORE</Text>
      ...
      >
        ...
        {/* 1 What */}
        <View
          onLayout={(e) => onSectionLayout('s1', e.nativeEvent.layout.y)}
        >
        ...
        {/* 2 Why */}
        <View
          onLayout={(e) => onSectionLayout('s2', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s2')} reduceMotion={reduceMotion} delay={40}>
            <View style={styles.section}>
        ...
        {/* 3 Autopilot */}
        <View
          onLayout={(e) => onSectionLayout('s3', e.nativeEvent.layout.y)}
        >
        ...
        {/* 4 Buyers */}
        <View
          onLayout={(e) => onSectionLayout('s4', e.nativeEvent.layout.y)}
        >
        ...
        {/* 5 Sellers */}
        <View
          onLayout={(e) => onSectionLayout('s5', e.nativeEvent.layout.y)}
        >
        ...
        {/* 6 Discovery */}
        <View
          onLayout={(e) => onSectionLayout('s6', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s6')} reduceMotion={reduceMotion}>
            <View style={styles.section}>
              ...
              />
              <Body>
                Traditional marketplaces often begin with a question: “What are you
                looking for?” Plazore also asks another:
              </Body>
              ...
              <Body>
                ...
                accidental click should not define someone’s experience. Meaningful
                signals matter more.
              </Body>
              <Body>
        ...
        {/* 7 AI */}
        <View
          onLayout={(e) => onSectionLayout('s7', e.nativeEvent.layout.y)}
        >
        ...
        {/* 8 Confidence */}
        <View
          onLayout={(e) => onSectionLayout('s8', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s8')} reduceMotion={reduceMotion}>
            <View style={styles.section}>
              ...
              <Body>
                High Confidence means there is meaningful supporting information
                and marketplace activity. Growing means useful signals are
                developing. Limited means there is not yet enough supporting
                information or activity to provide stronger context.
              </Body>
              <Text style={styles.emphasis}>
                Limited does not automatically mean a product is bad. It means
                there is less information available to support a stronger
                conclusion.
              </Text>
            </View>
          </FadeIn>
        ...
        {/* 9 Commerce */}
        <View
          onLayout={(e) => onSectionLayout('s9', e.nativeEvent.layout.y)}
        >
        ...
        {/* 10 Trust */}
        <View
          onLayout={(e) => onSectionLayout('s10', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s10')} reduceMotion={reduceMotion}>
            <View style={styles.section}>
              ...
              <SectionMedia
                uri={IMG.trust}
                caption="Payment · order · fulfilment"
                width={winW}
              />
              <Body>
        ...
        {/* 11 Shop & Earn */}
        <View
          onLayout={(e) => onSectionLayout('s11', e.nativeEvent.layout.y)}
        >
        ...
        {/* 12 Surfaces */}
        <View
          onLayout={(e) => onSectionLayout('s12', e.nativeEvent.layout.y)}
        >
        ...
        {/* 13 Direction */}
        <View
          onLayout={(e) => onSectionLayout('s13', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s13')} reduceMotion={reduceMotion}>
            <View style={styles.section}>
              ...
              <Text style={styles.emphasis}>
                Commerce is the beginning. Fully autonomous commerce is a direction
                we are pursuing — not a claim of what is already complete.
              </Text>
            </View>
          </FadeIn>
        </View>
        ...
        {/* 14 Principle */}
        <View
          onLayout={(e) => onSectionLayout('s14', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s14')} reduceMotion={reduceMotion}>
            <View style={styles.section}>
              ...
              <Body>
                The unfamiliar experience is intentional. The familiar fundamentals
                are intentional. The intelligence is intentional. The simplicity is
                intentional.
              </Body>
              <Text style={styles.emphasis}>
        ...
        {/* Closing */}
        <View
          onLayout={(e) => onSectionLayout('s15', e.nativeEvent.layout.y)}
        >
          <FadeIn visible={v('s15')} reduceMotion={reduceMotion}>
            ...
            >
              <Image
                source={LOGO}
                style={styles.closingLogo}
                resizeMode="contain"
              />
              <Text style={styles.closingTag}>
                THE NEW WAY TO SHOP AND EARN.
              </Text>
              <Text style={styles.closing2040}>
...
const styles = StyleSheet.create({
  ...
  topTitle: { color: TEXT, fontSize: 17, fontWeight: '700' },
  ...
  closingCtaText: { color: '#041412', fontWeight: '800', fontSize: 14 },
})