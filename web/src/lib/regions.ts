...
/** Deterministic money string — identical on server and client (no locale drift). */
export function formatMoney(
  ...
  // NGN + CFA: whole units; others: always 2 decimals
  const zeroDecimal =
    code === "XOF" || code === "XAF" || code === "NGN" || code === "KES";
