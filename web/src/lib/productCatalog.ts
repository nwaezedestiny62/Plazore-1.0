export const PRODUCT_CATEGORIES: Record<string, string[]> = {
  ...
  Computers: ['Laptops', 'Desktops', 'Monitors', 'Components', 'Peripherals', 'Chargers', 'Other'],
  ...
  Groceries: ['Food', 'Fruit', 'Beverages', 'Snacks', 'Pantry', 'Other'],
  Health: ['Supplements', 'Medical Devices', 'Wellness', 'Other'],
  'Sports & Outdoors': ['Fitness', 'Camping', 'Cycling', 'Team Sports', 'Other'],
  Automotive: ['Cars', 'Cycles', 'Buses', 'Heavy Automobiles', 'Parts', 'Accessories', 'Tools', 'Other'],
